$(document).ready(function(){
  ...
  function getElectionTypes(){
      $.ajax({
       url:"/wyl/electiontype/"+election_id,
       success:function(data){
   ...
   function getStates(){
         $.ajax({
          url:"/wyl/states/"+election_id+"/"+electionType_id,
          success:function(data){
     ...
     function getConstituency(){
              $.ajax({
               url:"/wyl/constituency/"+electionType_id+"/"+state_id,
               success:function(data){
      ...
      $("#filter").click( function(){
          if(election_id == undefined || electionType_id == undefined || state_id == undefined || constituency_id == undefined){
            ...
            $.ajax({
               url:"/wyl/candidates/"+constituency_id,
               success:function(data){
